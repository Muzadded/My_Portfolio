...
export default function PapersPage() {
  ...
  useEffect(() => {
    ...
    const metrics = document.querySelectorAll('.performance-metric-card')
      ...
      <main className="pt-32 pb-section-gap">
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 mb-24">
          <div className="mb-16">
            ...
            <h1 className="font-headline-xl text-headline-lg-mobile md:text-headline-xl mt-4 max-w-3xl text-on-surface">
          ...
          <div className="grid grid-cols-1 gap-8">
            {papers.map((paper, index) => (
              <div
                key={index}
                className="glass-card p-8 rounded-xl flex flex-col md:flex-row gap-8 items-start scroll-reveal border border-white/5"
              >
                <div className="flex-1">
                  ...
                  <h2 className="font-headline-lg text-title-md text-on-surface mb-4 font-semibold">
                    {paper.title}
                  </h2>
                ...
                {/* Right Metric Card */}
                {paper.hasChartIcon ? (
                  <div className="md:w-64 w-full h-[140px] flex items-center justify-center performance-metric performance-metric-card p-6 rounded-lg border border-primary/10 opacity-60">
                    <span className="material-symbols-outlined text-headline-xl text-secondary text-5xl">
                      analytics
                    </span>
                  </div>
                ) : (
                  <div className="md:w-64 w-full h-[140px] flex flex-col justify-between performance-metric performance-metric-card p-6 rounded-lg border border-primary/10">
                    <div>
        ...
        {/* Section: Education */}
        <section className="max-w-7xl mx-auto px-6 md:px-12 scroll-reveal">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              <span className="font-label-sm text-label-sm text-secondary-container tracking-widest uppercase font-bold">
                Foundation
              </span>
              <h2 className="font-headline-xl text-headline-lg-mobile md:text-headline-xl mt-4 text-on-surface">
                My Education
              </h2>
            </div>
            ...
            <div className="lg:col-span-7">
              <div className="space-y-10">
                <div className="flex flex-col gap-4">
                  ...
                  <div className="mt-8">
                    <h4 className="font-label-md text-label-md text-on-surface mb-4 uppercase text-xs font-bold">
                      Core Focus Areas
                    </h4>
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 mt-24">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {credentials.map((cred, index) => (
              <div
                key={index}
                className={`glass-card p-8 rounded-xl flex flex-col justify-between min-h-[200px] border-l-4 ${cred.borderColor} border border-white/5 scroll-reveal`}
              >
                <div>
