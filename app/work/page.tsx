...
export default function WorkPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-on-background relative overflow-x-hidden">
      ...
      <main className="relative pt-32 pb-section-gap px-6 md:px-12 max-w-7xl mx-auto overflow-hidden">
        {/* Header Section */}
        <section className="relative z-10 mb-8 max-w-4xl">
          <span className="font-label-caps text-label-caps text-secondary tracking-[0.2em] mb-4 block">
            MY JOURNEY
          </span>
          <h1 className="font-display-xl text-headline-xl mb-6">
        ...
        {/* Timeline Container */}
        <section className="relative z-10 mt-20 ml-4 md:ml-0">
          ...
          {experienceItems.map((item, index) => (
            ...
            >
              ...
              <div className="md:w-[45%] glass-card p-6 rounded-xl border border-white/5 reveal-card">
        ...
        <section className="mt-24 z-10 relative">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-2 glass-card p-10 rounded-xl flex flex-col justify-between min-h-[320px] border border-white/5 reveal-card">
              <div>
            ...
            <div className="glass-card overflow-hidden rounded-xl h-[320px] relative group border border-white/5 reveal-card">
              <img
