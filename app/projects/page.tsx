...
export default function ProjectsPage() {
  // Add mousemove listeners for bento highlight positioning
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-background text-on-background relative overflow-x-hidden">
      ...
      <main className="relative pt-32 pb-section-gap px-6 md:px-12 max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="mb-12 space-y-4 text-center md:text-left">
          ...
          <h1 className="font-headline-xl text-headline-xl md:text-[64px] text-on-surface">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mt-16">
          ...
          <div className="md:col-span-7 glass-card rounded-xl p-8 flex flex-col justify-between group overflow-hidden relative interactive-card border border-white/5 min-h-[380px]">
          ...
          <div className="md:col-span-5 glass-card rounded-xl p-8 flex flex-col justify-between group overflow-hidden relative interactive-card border border-white/5 min-h-[380px]">
            <div className="card-highlight"></div>
            <div className="relative z-10">
